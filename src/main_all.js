...
const benchmarkUnittest = require('./benchmark_unittest.js');
...
// Unit test.
async function mainUnittest(tfjsdir) {
  return benchmarkUnittest.runBenchmarks(tfjsdir);
}
...
async function main() {
    ...
    const unitResultTable =  await mainUnittest(util.tfjsdir);
